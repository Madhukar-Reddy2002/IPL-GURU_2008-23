...
fig_runs_per_match = px.line(total_runs_per_match, x='start_date', y='total_runs', title='Total Runs per Match', color_discrete_sequence=['blue'])
st.plotly_chart(fig_runs_per_match)
...
fig_wickets_per_match = px.line(total_wickets_per_match, x='start_date', y='total_wickets', title='Total Wickets per Match', color_discrete_sequence=['red'])
st.plotly_chart(fig_wickets_per_match)
